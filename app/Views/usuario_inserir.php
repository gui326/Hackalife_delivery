...
<body>
    ...
    <div class="container-fluid d-md-flex  mt-2">
        ...
        <div id="content">
            <form action="<?= site_url('public/usuario/inserir') ?>" method="post" style="box-shadow: none !important; border: 1px solid rgb(0, 0, 0);" class="p-lg-5 mx-auto mt-5 w-100">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="quantidade" class=" p-2" style="min-width: 70px !important; width: 70px;" placeholder="QTD">
                                    </td>
                                </tr>
